    ...
    methods: {
	   ...
	   this.fetchNui(`um-admin:nuicallback:${callBack}`, '')
        ...
        setDistance() {
            ...
            this.fetchNui('um-admin:client:viewdistance',this.distance)
        },
        keyupHandler(e) {
            if (e.key == "Escape") {
                this.minpage = false;
        ...
        eventHandler(e) {
            ...
            switch (d.type) {
                ...
                case "playerprofile":
                    ...
                    .catch(() =>  {
                        this.steam.avatar = "assets/img/steam.png"
                    ...
                    .catch(() =>  {
                        this.discord.avatar = "assets/img/discord.png"
