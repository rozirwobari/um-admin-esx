...
ToggleNoClip = function(state)
    ...
    lib.notify({
        title = 'Admin Menu',
        description = IsNoClipping and "Noclip diaktifkan" or "Noclip dinonaktifkan",
        type = IsNoClipping and 'success' or 'warning',
        duration = 5000,
        style = {
            borderRadius = "13px",
        }
...
RegisterNetEvent('um-admin:client:ToggleNoClip', function()
