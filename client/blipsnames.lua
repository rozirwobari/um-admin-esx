...
CreateThread(function()
    while true do
        ...
        if NetCheck1 or NetCheck2 then
            TriggerServerEvent('um-admin:server:GetPlayersForBlips')
        end
    end
end)

RegisterNetEvent('um-admin:client:toggleBlips', function()
    if not ShowBlips then
        ShowBlips = true
        NetCheck1 = true
        lib.notify({
            title = 'Admin Menu',
            description = "Blips diaktifkan",
            type = 'success',
            duration = 5000,
            style = {
                borderRadius = "13px",
        ...
        lib.notify({
            title = 'Admin Menu',
            description = "Blips dinonaktifkan",
            type = 'error',
            duration = 5000,
            style = {
                borderRadius = "13px",
...
RegisterNetEvent('um-admin:client:toggleNames', function()
    ...
    if not ShowNames then
        ...
        lib.notify({
            title = 'Admin Menu',
            description = "Nama dinonaktifkan",
            type = 'error',
            duration = 5000,
            style = {
                borderRadius = "13px",
...
RegisterNetEvent('um-admin:client:Show', function(players)
