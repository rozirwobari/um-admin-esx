...
local GetEntityInfo = function(entity)
    ...
    local entityData    = {
        ...
        'Entity ID: ~y~'..(NetworkGetEntityIsNetworked(entity) and NetworkGetNetworkIdFromEntity(entity) or "Not registered"),
            ...
            if EntityFreeAim then
                ...
                if hit and (IsEntityAVehicle(entity) or IsEntityAPed(entity) or IsEntityAnObject(entity)) then
                    ...
                    if IsControlJustReleased(0, 47) then -- Freeze entities
                        ...
                        lib.notify({
                            title = 'Admin Menu',
                            description = "Anda memiliki "..(FrozenEntities[entity] and "Terbekukan" or "Tidak Terbekukan").."entitas freeaim",
                            type = (FrozenEntities[entity] and 'success' or 'error'),
                            duration = 5000,
                            style = {
                                borderRadius = "13px",
                            }
                    ...
                    if IsControlJustReleased(0, 38) then -- Delete entity
                        ...
                        if not DoesEntityExist(entity) then
                            ...
                            lib.notify({
                                title = 'Admin Menu',
                                description = "Gagal menghapus entitas",
                                type = 'error',
                                duration = 5000,
                                style = {
                                    borderRadius = "13px",
                    ...
                    if IsControlJustReleased(0, 101) then -- Copy entity
                        TriggerEvent('um-admin:client:copyToClipboard', 'freeaimEntity')
                    end
                else
                    FreeAimEntity = nil
                end
